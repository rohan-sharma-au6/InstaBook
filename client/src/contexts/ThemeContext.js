...
class ThemeContextProvider extends Component {
  state = {
    ...
    dark: { syntax: '#ddd', ui: '#30404D', bg: '#555',head:"blueviolet",bar:"bp3-navbar bp3-dark ",pop:"bp3-popover-content-sizing bp3-dark",ib:"#18191B",bor:"whitesmoke 1px solid",gr:"linear-gradient(to right, #0f2027, #203a43, #2c5364)"},
    curruser:[]
  }
  componentDidMount(){
